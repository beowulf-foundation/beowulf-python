        ...
        if isArgsThisClass(self, args):
            ...
            super(SignedTransaction, self).__init__(
                OrderedDict([
                    ...
                    ('created_time', Uint64(kwargs['created_time'])),
...
def fmt_time_from_now_to_epoch(secs=0):
    """ Properly Format Time that is `x` seconds in the future
